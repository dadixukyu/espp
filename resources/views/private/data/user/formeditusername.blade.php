<div class="modal fade" id="modalFormData" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" data-bs-backdrop='static' data-bs-keyboard="false">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{ route('userdata.updateusername', $id) }}" class="formData" method="POST">
                @csrf
                ...
                <div class="modal-body">
                    <div class="border p-4 rounded">
                        <div class="card-title d-flex align-items-center">
                            <div><i class="bx bx-user me-1 font-22 text-info"></i>
                            </div>
                            <h5 class="mb-0 text-info">User Update</h5>
                        </div>
                        <hr/>
                        <div class="row">
                            <label for="email" class="col-sm-3 col-form-label">Username</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" name="email" id="email" placeholder="Nama User" value="{{ $row->email }}">
                            </div>
                        </div> 
                    </div>
                </div>
