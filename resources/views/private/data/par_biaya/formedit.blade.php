    ...
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            ...
            <div class="modal-header bg-light py-2">
                <h6 class="modal-title text-primary">Form Data Biaya</h6>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>

            <form action="{{ route('parbiayadata.update', $id_biaya) }}" class="formData" method="POST">
                @csrf
                    ...
                    <div class="border border-2 p-3 rounded">
                        ...
                        {{-- <div class="mb-2">
                            ...
                            <input type="number" name="tahun" class="form-control form-control-sm" min="2000"
                                max="2099" placeholder="Masukkan Tahun" value="{{ $row->tahun }}">
                        </div> --}}

                        <div class="mb-2">
                            <label class="form-label mb-1">Nama Biaya <span class="text-danger">*</span></label>
                            <input type="text" name="nama_biaya" class="form-control form-control-sm"
                                placeholder="Masukkan nama biaya" value="{{ $row->nama_biaya }}">
                        </div>
