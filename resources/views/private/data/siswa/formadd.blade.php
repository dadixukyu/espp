        ...
        <div class="modal-content">
            ...
            <div class="modal-header bg-primary text-white">
                <h5 class="modal-title">
                    <i class="bx bx-user-plus me-2"></i> Form Data Siswa
                </h5>
            ...
            <!-- FORM START -->
            <form action="{{ route('siswadata.store') }}" class="formData" method="POST">
                @csrf
                ...
                <div class="modal-body" style="max-height:70vh; overflow-y:auto;">
                    <div class="p-3 border rounded shadow-sm bg-light">
                        ...
                        <h5 class="mb-3 text-primary">
                            <i class="bx bx-edit-alt me-1"></i> {{ $title_form ?? 'FORM INPUT DATA SISWA' }}
                        </h5>
                        <hr class="mb-4" />
                        ...
                        <div class="mb-3">
                            <label class="form-label fw-bold">
                                <i class="bx bx-calendar me-1 text-primary"></i> Tahun Ajaran
                            </label>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    <label class="form-label fw-bold">
                                        <i class="bx bx-user-circle me-1 text-primary"></i> Nama Lengkap
                                    </label>
                            ...
                            <div class="col-md-6">
                                ...
                                <h6 class="text-secondary fw-bold d-flex align-items-center">
                                    <span class="me-2">
                                        <i class="bx bx-graduation text-secondary"></i>
                                        <i class="bx bx-book-open text-secondary"></i>
                                    </span>
                                    Data Akademik
                                </h6>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="tahun_masuk" class="form-control" min="2000"
                                        max="2099" placeholder="Masukkan tahun masuk">
                                </div>
                                ...
                                <!-- Data Orang Tua / Wali -->
                                <h6 class="text-secondary fw-bold mt-4">
                                    <i class="bx bx-user-pin me-1"></i> Data Orang Tua / Wali
                                </h6>

                                <div class="mb-3">
                                    <label class="form-label fw-bold">
                                        <i class="bx bx-male me-1 text-primary"></i> Nama Ayah
                                    </label>
                                ...
                                <div class="mb-3">
                                    <label class="form-label fw-bold">
                                        <i class="bx bx-briefcase me-1 text-primary"></i> Pekerjaan Ayah
                                    </label>
                                ...
                                <div class="mb-3">
                                    <label class="form-label fw-bold">
                                        <i class="bx bx-female me-1 text-primary"></i> Nama Ibu
                                    </label>
                                ...
                                <div class="mb-3">
                                    <label class="form-label fw-bold">
                                        <i class="bx bx-briefcase me-1 text-primary"></i> Pekerjaan Ibu
                                    </label>
                                ...
                                <div class="mb-3">
                                    <label class="form-label fw-bold">
                                        <i class="bx bx-user me-1 text-primary"></i> Nama Wali
                                    </label>
                                ...
                                <div class="mb-3">
                                    <label class="form-label fw-bold">
                                        <i class="bx bx-phone-call me-1 text-primary"></i> No HP Wali
                                    </label>
                                ...
                                <div class="mb-3">
                                    <label class="form-label fw-bold">
                                        <i class="bx bx-home-alt me-1 text-primary"></i> Alamat Wali
                                    </label>
                                    <textarea name="alamat_wali" class="form-control" rows="2" placeholder="Masukkan alamat wali"></textarea>
                                </div>
