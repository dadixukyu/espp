...
@section('isi')
    ...
    <div class="d-flex align-items-center mb-4 p-4 rounded bg-primary-subtle border-start border-4 border-primary shadow-sm">
        ...
        <div>
            <h5 class="fw-bold mb-1 text-dark">Data Personal Siswa</h5>
            <small class="text-muted"><i class="bx bx-info-circle me-1"></i> Kelola informasi siswa secara lengkap</small>
        </div>
    </div>
        ...
        <div class="col-lg-12">
            <div class="card">
                {{-- <div class="card-header">
                    ...
                    <p class="card-text" align="right"> <button data-url="" type="button"
